...
const routes = {
  '/': {
    ...
    keywords: 'system design, architecture diagram, system design interview, software architecture, distributed systems',
    content: `
  ...
  '/#/playground/free': {
    ...
    description: 'Create unlimited system architecture diagrams for free. 45+ components including load balancers, databases, caches, queues, and more. No signup required.',
    keywords: 'free system design tool, architecture diagram maker, cloud architecture, microservices design',
    content: `
  ...
  '/#/problems': {
    ...
    description: 'Practice system design with real-world challenges. Get AI-powered feedback on your architecture designs. Perfect for interview preparation.',
    keywords: 'system design interview, system design practice, distributed systems problems, scalable architecture',
    content: `
